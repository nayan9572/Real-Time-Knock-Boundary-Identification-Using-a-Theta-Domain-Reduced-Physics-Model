...
| Peak end-gas temperature | 🔥 **{peak_endgas_temp:.1f} K** | B2 chemistry |
| Peak cylinder pressure (B2) | **{peak_pressure_b2:.1f} bar** | B2 physics |
| Peak pressure (extreme env) | 💥 **{peak_pressure_extreme:.1f} bar** | Extreme env |
| Peak temperature (extreme env) | 🔥 **{peak_temp_extreme:.1f} K** | Extreme env |
...
### Interpretation
- Knock requires **KI ≥ 1** (auto-ignition condition)
